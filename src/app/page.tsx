...
<div className="flex ml-60 gap-10 p-10 bg-[#FFF9EF] rounded-lg">
  ...
  <div className="flex flex-col items-center">
    ...
    <div>
      ...
      <div>
        <h1 className="text-center  font-bold text-4xl mt-[10%] mb-[8%] ">Our Service</h1>
      </div>
      <div className="flex ml-40 gap-60">
        <div>
      ...
      <div className="text-center mt-[10%] ">
        ...
        <img src="images/quotes.png" alt="" className="justify-center mx-[800px]"/>
      ...
      <div className="flex pl-80 gap-10 mx-[90px]">
      <div>
